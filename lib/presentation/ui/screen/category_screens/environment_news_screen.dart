...
class EnvironmentNewsScreen extends StatefulWidget {
  final String title;
  const EnvironmentNewsScreen({
    super.key,
    required this.title,
  });

  @override
  State<EnvironmentNewsScreen> createState() => _EnvironmentNewsScreenState();
}

class _EnvironmentNewsScreenState extends State<EnvironmentNewsScreen> {
