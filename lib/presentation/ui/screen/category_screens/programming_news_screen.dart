...
class ProgrammingNewsScreen extends StatefulWidget {
  final String title;
  const ProgrammingNewsScreen({super.key, required this.title});

  @override
  State<ProgrammingNewsScreen> createState() => _ProgrammingNewsScreenState();
}

class _ProgrammingNewsScreenState extends State<ProgrammingNewsScreen> {
