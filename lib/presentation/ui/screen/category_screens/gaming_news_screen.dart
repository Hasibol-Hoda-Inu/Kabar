...
class GamingNewsScreen extends StatefulWidget {
  final String title;
  const GamingNewsScreen({super.key, required this.title});

  @override
  State<GamingNewsScreen> createState() => _GamingNewsScreenState();
}

class _GamingNewsScreenState extends State<GamingNewsScreen> {
