...
class TapViewCybersecurityNewsScreen extends StatefulWidget {
  const TapViewCybersecurityNewsScreen({super.key,});

  @override
  State<TapViewCybersecurityNewsScreen> createState() => _TapViewCybersecurityNewsScreenState();
}

class _TapViewCybersecurityNewsScreenState extends State<TapViewCybersecurityNewsScreen> {
  ...
  Future<void> getTNData()async {
    ...
    final NetworkResponse response = await NetworkCaller.getRequest(Urls.cyberCategory);
