...
class TapViewSpaceNewsScreen extends StatefulWidget {

  const TapViewSpaceNewsScreen({super.key,});

  @override
  State<TapViewSpaceNewsScreen> createState() => _TapViewSpaceNewsScreenState();
}

class _TapViewSpaceNewsScreenState extends State<TapViewSpaceNewsScreen> {
