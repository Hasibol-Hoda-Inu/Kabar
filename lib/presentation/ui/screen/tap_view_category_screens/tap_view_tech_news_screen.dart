...
class TapViewTechNewsScreen extends StatefulWidget {
  const TapViewTechNewsScreen({super.key});

  @override
  State<TapViewTechNewsScreen> createState() => _TapViewTechNewsScreenState();
}

class _TapViewTechNewsScreenState extends State<TapViewTechNewsScreen> {
